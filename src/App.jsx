...
const EXTRA_GUESSES = [
"محاذر", "التفع", "تسريب", "مداوم", "تفريغ", "مفتوق", "مرتجع", "تمكين", "التحف", "تناسق", "مضبوط", "تناذر", "ابتلج", "مملوح", "غطريس", "مكتنز", "التبس", "تلويم", "انحجب", "تقليم", "وساوس", "متقرح", "تعميد", "أبواق", "تفصيح", "مقنطر", "توشيح", "مخالف", "تبعثر", "مهاجم", "فوضوي", "مكهرب", "اندفع", "تكميم", "أعماق", "اغتمس", "مشتمل", "تعارف", "تهاتر", "معلوف", "تأقلم", "تباعد", "إقبال", "معروق", "انفسد", "أحوال", "تقنين", "ماجدة", "نواحي", "متهرئ", "عطشان", "تنفيس", "إمهال", "توزيع", "مخاطب", "تفاقم", "ابتعث", "مهلهل", "وقائع", "تنصير", "أطباق", "تصوير", "انطمس", "تقريظ", "إنسان", "تقطير", "وسائد", "تعزيم", "انفطر", "مبايع", "تهامل", "إمرار", "انصقل", "مشفوع", "انتسق", "معدول", "أبحاث", "منفجر", "تكحيل", "مداهم", "تجلبب", "مهراق", "تلفلف", "مبارز", "امتحق", "إرباك", "مسدود", "إعنات", "توطيد", "انخنق", "تصحيف", "انغمر", "انجلف", "تهريب", "إصلاح", "تنشيف", "معطوب", "تكريس", "مندوف", "تبلبل", "انزرع", "تقديس", "مرصوف", "صنديد", "محافظ", "انعكس", "تقريب", "مجنون", "تكعيب", "انمحق", "منتجع", "إقفار", "تمتين", "انعرج", "تناظم", "منعقد", "نهاية", "منقوع", "تطمين", "أوقاف", "تكديس", "ملحاح", "تقذيف", "مساوم", "تضعضع", "مصادف", "تشويق", "انجلب", "متوسط", "إنشاد", "نحفاء", "متمثل", "تظافر", "تنويم", "إغلاق", "منشور", "خلفاء", "منتشب", "خلايا", "تهندم", "إكبار", "مهفهف", "إخوان", "تصير", "إلغام", "تنقيص", "مراوغ", "تهليل", "انمحص", "تنميل", "إبصار", "تعويض", "مفاجئ", "تلوث", "إطعام", "أمواج", "تشكيك", "أولاد", "ممعنت", "إضلال", "تصميم", "انسحق", "مرتجل", "تناثر", "امتعض", "فتيان", "تطبيب", "أيتام", "انفتل", "جزيرة", "تتلمذ", "مكتشف", "تزعزع", "مقارن", "تأليه", "متضاد", "تصحيير", "تعاظم", "تصفيق", "أعشاب", "موقوف", "اتحاد", "تلفاز", "معيشي", "انفرط", "تتوكيل", "إمعان", "تشييط", "مصافح", "إقحام", "معانق", "تنعيم", "متنوع", "إتزان", "انصبغ", "مكفول", "انضغط", "تكييف", "منطلق", "تكهرب", "مخاصم", "تقطيع", "مهاود", "تنسيق", "إضرام", "اختبل", "مفتون", "منتجع", "إكساب", "مناضل", "انصرع", "مكذوب", "انفلق", "تعتيم", "ألغاز", "مخالط", "إيناع", "انتبثر", "إعوال", "انحسم", "تشقلب", "إعواز", "تجاور", "تناغم", "مذاعن", "إنتاج", "معقود", "انحذف", "إهمال", "تظريف", "ألوان", "مبارح", "توطين", "مشارك", "اعتدل", "مقنوص", "إلحاف", "معنوي", "اندرج", "تفرقة", "موجود", "تبحثتر", "انخصم", "تطهير", "إلحاق", "منظور", "تكاسل", "انشطير", "تصديق", "انفرج", "تواصل", "انفتق", "تكاثر", "مفلول", "تنكيت", "افتخر", "مهادن", "تبرقع", "أوصاف", "تعضيد", "مفهرس", "إيحاش", "متقطع", "رائدة", "تلوين", "جعجاع", "مطروق", "استتب", "انعصر", "متقيح", "انفلع", "مراسل", "تنزيه", "إضمار", "تعزيز", "انثلم", "تقشير", "ململم", "تصاغر", "ملضوم", "تظارف", "مضغوط", "إكثار", "تمشيط", "إكباب", "ميسور", "اعتزم", "اندلق", "مصروع", "إيقاف", "تبهدل", "انصعق", "تأصيل", "إلزام", "عقوبي", "إطلاع", "أخبار", "معتقد", "نبيلة", "اعترم", "تلاعب", "مشروط", "ابتاع", "التأم", "مشاكل", "توتير", "مفلفل", "تهجير", "ملعوب", "تطفيف", "مغموس", "تلكلك", "مواجهة", "تبلشف", "انزجر", "مفكوك", "انخلع", "مهترئ", "تلازم", "اصطبغ", "مفروش", "انخذل", "معصفر", "انكرب", "تمويل", "فرحان", "مصارح", "تبتيك", "عمالق", "تطريب", "أوجاع", "منطيق", "صلب", "مندمج", "فخاري", "مخارج", "تنويه", "إطفاح", "مهموس", "انقشر", "مفلطح", "انتكس", "مشمول", "إتضاح", "مناهض", "توصيف", "جزائر", "تنشيط", "مواصف", "تساهل", "متفرق", "انجرح", "تضييق", "مسحوب", "تهديف", "أصحاب", "توقيع", "انحصر", "مقتضب", "إكراه", "سرادق", "تمصير", "تعاكس", "طفولي", "احترس", "مشايع", "ترنيم", "إلباس", "تكريم", "تراحم", "أمراض", "تطويق", "منمنم", "إيصال", "مركوب", "قتنع", "مضموم", "تصنيف", "انسفك", "تمليق", "متورد", "أحيان", "إفراغ", "تصحيح", "وثائق", "امتزج", "توافر", "مناقض", "تفريد", "مفروم", "تعليل", "أطماع", "تغليظ", "منفرط", "اصطحب", "تعريف", "مقرور", "تفاحش", "منزرع", "انحبس", "تبشيع", "متكثر", "تماهل", "انفصم", "انحفر", "مؤاخذ", "تهويم", "إيصال", "إيضاح", "إيطار", "إيعاد", "إيفاء", "إيفاد", "زائدة", "زائرة", "زابون", "زاجرة", "ناعتة", "ناعمة", "ناعية", "نافذة", "نافثة", "نافعة", "ناقلة"
];
